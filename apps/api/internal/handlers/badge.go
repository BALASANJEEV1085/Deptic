...
func (h *BadgeHandler) AddBadgeToReadme(c *fiber.Ctx) error {
	...
	if readmeFound {
		...
		readmeContent = fmt.Sprintf("# %s\n\n%s\n\n## About\n\nThis repository uses [Deptic](https://deptic.in) for automated software supply chain security scanning and SBOM generation.\n", repo, badgeMarkdown)
	}
