...
function TrustStat({
  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <span className="mt-1 text-xs text-[#888888] md:text-sm">{label}</span>
    </div>
  )
}
  ...
  return (
    ...
    >
      <div className="relative z-10 flex w-full max-w-4xl flex-col items-center pt-20 text-center">
        {/* pill badge */}
        <div
          className="mb-8 flex items-center gap-2 rounded-full border border-[#1a1a1a] bg-[#0a0a0a] px-3.5 py-1.5 transition-all duration-700"
          style={{
            opacity: mounted ? 1 : 0,
        ...
        >
          ...
          <span className="text-xs text-white">Now supporting 4 ecosystems</span>
        </div>

        {/* H1 */}
        <h1 className="font-heading text-[22px] font-extrabold leading-[1.08] tracking-[-0.02em] text-white sm:text-[28px] md:text-[38px]">
        ...
        <p
          className="mt-6 max-w-[560px] text-base text-[#888888] transition-opacity duration-700 md:text-lg"
        ...
        >
          <div className="flex h-14 items-center rounded-full border border-[#2a2a2a] bg-[#1a1a1a] pl-6 pr-1.5">
            <input
              name="repoUrl"
              type="text"
              placeholder="Enter repository url to scan"
              aria-label="Repository URL"
              className="h-full flex-1 bg-transparent text-[15px] text-white placeholder:text-[#666666] focus:outline-none"
            />
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-x-10 gap-y-6">
          ...
          <div className="flex flex-col items-center text-center">
            <span className="text-xl font-semibold text-white md:text-2xl">100%</span>
            <span className="mt-1 text-xs text-[#888888] md:text-sm">free to start</span>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-8 left-1/2 z-10 flex -translate-x-1/2 flex-col items-center gap-2">
        ...
        <span className="text-[11px] text-[#888888]">scroll</span>
      </div>
    </section>
  )
}
