    ...
    <div className="min-h-screen bg-[var(--lp-bg)] text-[var(--lp-text)] font-sans selection:bg-[var(--lp-green)]/30 selection:text-[var(--lp-green)]">
      ...
      <main className="pt-32 pb-20 px-6 max-w-3xl mx-auto">
        <header className="mb-16">
          ...
          <h1 className="font-syne text-4xl md:text-5xl font-extrabold tracking-tight text-foreground mb-6">Privacy Policy</h1>
          <p className="text-[var(--lp-text2)] font-light">Last Updated: May 10, 2026</p>
        </header>

        <article className="prose prose-invert max-w-none space-y-12">
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">1. Data we collect</h2>
            ...
            <ul className="list-disc list-inside mt-4 text-[var(--lp-text2)] font-light space-y-2">
              ...
              <li>Dependency manifest files required to generate DEPTICs.</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">3. Third-party disclosure</h2>
            <p className="text-[var(--lp-text2)] font-light leading-relaxed">
          ...
          <section className="bg-[var(--lp-card)] border border-[var(--lp-border)] rounded-xl p-8">
            ...
            <p className="text-sm text-[var(--lp-text2)] font-light leading-relaxed">
              All data transmitted between your browser and our servers is encrypted using TLS 1.3. Generated DEPTICs are stored using AES-256 encryption at rest.
            </p>
          </section>
        </article>
      </main>
