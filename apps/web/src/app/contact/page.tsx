        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            <header className="mb-12">
              ...
              <h1 className="font-syne text-5xl md:text-6xl font-extrabold tracking-tight text-foreground mb-6">Get in touch</h1>
            ...
            <div className="space-y-8">
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-muted/50 border border-[var(--lp-border)] rounded-xl flex items-center justify-center shrink-0">
                  <Send className="text-[var(--lp-green)]" size={20} />
                </div>
                <div>
                  <h4 className="font-bold text-foreground mb-1">Email</h4>
                  <p className="text-[var(--lp-text2)] font-light">support@deptic.io</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-muted/50 border border-[var(--lp-border)] rounded-xl flex items-center justify-center shrink-0">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-1">Twitter</h4>
                  <p className="text-[var(--lp-text2)] font-light">@deptic_io</p>
                </div>
              </div>
            </div>
          </div>
