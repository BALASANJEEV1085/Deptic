        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            <header className="mb-12">
              <div className="text-[#22c55e] text-xs font-bold uppercase tracking-[0.2em] mb-4">Connect</div>
              <h1 className="font-syne text-5xl md:text-6xl font-extrabold tracking-tight text-white mb-6">Get in touch</h1>
              <p className="text-[#8b91a8] text-lg font-light leading-relaxed">
            ...
            <div className="space-y-8">
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-white/[0.03] border border-[#1e2230] rounded-xl flex items-center justify-center shrink-0">
                  <Send className="text-[#22c55e]" size={20} />
                </div>
                <div>
                  <h4 className="font-bold text-white mb-1">Email</h4>
                  <p className="text-[#8b91a8] font-light">support@sbom.io</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-white/[0.03] border border-[#1e2230] rounded-xl flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <p className="text-[#8b91a8] font-light">Available for Pro and Enterprise users.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-white/[0.03] border border-[#1e2230] rounded-xl flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <p className="text-[#8b91a8] font-light">@sbom_io</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-xs font-bold text-[#4a5068] uppercase tracking-widest">First Name</label>
                  <input type="text" className="w-full bg-[#0a0c10] border border-[#1e2230] rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-[#22c55e]/50 transition-colors" placeholder="John" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-[#4a5068] uppercase tracking-widest">Last Name</label>
                  <input type="text" className="w-full bg-[#0a0c10] border border-[#1e2230] rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-[#22c55e]/50 transition-colors" placeholder="Doe" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-xs font-bold text-[#4a5068] uppercase tracking-widest">Work Email</label>
                <input type="email" className="w-full bg-[#0a0c10] border border-[#1e2230] rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-[#22c55e]/50 transition-colors" placeholder="john@company.com" />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-bold text-[#4a5068] uppercase tracking-widest">Message</label>
                <textarea className="w-full bg-[#0a0c10] border border-[#1e2230] rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-[#22c55e]/50 transition-colors min-h-[120px]" placeholder="How can we help?"></textarea>
              </div>
              <button type="submit" className="w-full lp-btn-primary py-4 text-base font-bold rounded-xl shadow-lg shadow-[#22c55e]/10">
                Send Message
              </button>
            </form>
          </div>
