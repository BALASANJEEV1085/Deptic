    ...
    <div className="min-h-screen bg-[var(--lp-bg)] text-[var(--lp-text)] font-sans selection:bg-[var(--lp-green)]/30 selection:text-[var(--lp-green)]">
      ...
      <main className="pt-32 pb-20 px-6 max-w-3xl mx-auto">
        <header className="mb-16">
          ...
          <h1 className="font-syne text-4xl md:text-5xl font-extrabold tracking-tight text-foreground mb-6">Terms of Service</h1>
        ...
        <article className="prose prose-invert max-w-none space-y-12">
          <section>
            ...
            <p className="text-[var(--lp-text2)] font-light leading-relaxed">
              By accessing DEPTIC.io, you agree to be bound by these terms. If you are using the service on behalf of an organization, you agree to these terms for that organization.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">2. Usage Rights</h2>
            <p className="text-[var(--lp-text2)] font-light leading-relaxed">
              You are granted a non-exclusive right to use the platform to generate DEPTIC reports and scan for vulnerabilities. You may not use the service for illegal activities or to intentionally bypass security measures.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-[var(--lp-text2)] font-light leading-relaxed">
              DEPTIC.io provides reports based on public vulnerability databases. While we strive for 100% accuracy, we do not guarantee that our reports are free of errors or omissions. The service is provided "as is".
            </p>
          </section>
